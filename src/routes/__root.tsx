...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Organiza torneios de Jiu-Jitsu: chaves, tatâmis e ecrãs ao vivo. Multi-academia.",
      },
      { name: "author", content: "MatComp" },
      { name: "theme-color", content: "#0a0a0b" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "MatComp" },
      { property: "og:title", content: "MatComp" },
      { property: "og:description", content: "Competições para academias — tipo Smoothcomp." },
